...
export function asAsrModelId(value: unknown, defaultModel: AsrModelId = DEFAULT_ASR_MODEL): AsrModelId {
  return value === 'faster-whisper-large-v3' || value === 'faster-whisper-large-v3-turbo' ? value : defaultModel
}
